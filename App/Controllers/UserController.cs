...
public class UserController : ControllerBase
{
    ...
    public async Task<ActionResult<DefaultResponse>> CreateStudentUser(CreateStudentUserRequest userData)
    {
        var result = await _identityService.AddStudentUser(userData);
    ...
    public async Task<ActionResult<DefaultResponse>> CreateProfessorUser(CreateProfessorUserRequest userData)
    {
        var result = await _identityService.AddProfessorUser(userData);
